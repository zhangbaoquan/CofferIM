...
public class SpUtils {
    ...
    public final static String SHAREPREFERENCES_NAME = "com.coffer.im.SharedPreferences";
    ...
    public void initSp(Context mContext) {
         ...
         */
        sp = mContext.getSharedPreferences(SHAREPREFERENCES_NAME, Context.MODE_PRIVATE);
        editor = sp.edit();
    }
